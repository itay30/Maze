...
public class MainActivity extends AppCompatActivity {
    ...
    public final int FAT_FINGERS_MARGIN = 15;
...
//        mToolBarText.setTypeface(typeFace);
    ...
    public void createMaze() {
        ...
        // Add start arrow pic
        int startCellArrowX = solutionAreas[0][0] + 12 + FAT_FINGERS_MARGIN;
        int startCellArrowY = solutionAreas[0][1] + 100 + FAT_FINGERS_MARGIN;
        ...
        // Add strawberry pic
        int endCellStrawberryX = solutionAreas[mMazeView.lengthOfSolutionPath - 1][0] + 8 + FAT_FINGERS_MARGIN;
        int endCellStrawberryY = solutionAreas[mMazeView.lengthOfSolutionPath - 1][1] + 10 + FAT_FINGERS_MARGIN;
